...
function Confirm(props) {
  ...
  const handleChange = (event) => {
    ...
    setValue(inputValue.slice(0, 6)); // Limit to 6 digits
  };
  return (
    <>
      <div className="md:flex h-screen">
        ...
        <div className="right bg-white w-[75%] mx-auto pt-10 mt-20">
          <p className="   text-3xl px-3 text-center md:hidden font-bold text-black">
            Immunization Monitoring System
          </p>
          <p className=" pt-10   text-3xl px-3 text-center font-bold text-[#137E8F]">
            Confirm-OTP
          </p>
          <div className="w-4/5 mt-10 max-w-md bg-white px-8 py-2 shadow-lg rounded-lg mx-auto pt-20">
        
            <p variant="h5" className=" text-lg  ">
              Please enter the OTP to varify your account
            </p>
            <div className="flex text-sm text-gray-600 text-center m-2">
                <label htmlFor="">Email : </label>
                <p className="ms-1 text-[#137E8F]"> test@gmail.com</p>
              </div>
            ...
            />
             <button className="container w-full bg-[#137E8F] py-2 text-center text-white rounded-md mb-3">
            Submit
          </button>
          </div>
        </div>
