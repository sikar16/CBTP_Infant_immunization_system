          ...
          <TextField
            ...
            InputProps={{
              ...
              endAdornment: (
                <>
                  {showConfirmPassword ? (
                    <VisibilityOff onClick={handleToggleConfirmPassword} />
                  ) : (
                    <Visibility onClick={handleToggleConfirmPassword} />
                  )}
                </>
              ),
            }}
          />
          <button className="container w-full bg-[#137E8F] py-2 text-center text-white">
            Submit
          </button>
